function comprobarDatos() {
	...
	comprobar(nombre, dni, telef, nac, email, contraseina); 
...
function comprobar(nombre, dni, telef, nac, email, contraseina) {
	...
	if (nombre.length > 50) {window.alert("Nombre y apellidos demasiado largos, acórtelos."); return;}
	...
	if (!val) {window.alert("Estructura de DNI erronea, usa 12345678-Z"); return;}
